 ...
 *
 *	Programm zur Ansteuerung eines Standart LCD
 *	(HD44870),(SED1278F) und kompatible
 *
 *	USE_LCD_4Bit wird zur parallelen Ansteuerung benutzt (Ralf Figge)
 *
 * @{
 */
 ...
 * lcd.c
 *
 * \author Ulrich Radig & Ralf Figge
 */
 ...
 * \ingroup lcd
 *
 * Einstellung der Zeilenadresse für n mal 16 oder n mal 20 Character Display
 *
 */
...
/**
 *	\ingroup lcd
 *	Initialisierung der LCD Schnittstelle
 */
void lcd_init(void)
{	
#if USE_LCD_4Bit
...
/**
 *	\ingroup lcd
 *	Ausgabe auf der LCD Schnittstelle
 */
...
/**
 *	\ingroup lcd
 *	serielle Ausgabe eines Bytes auf LCD Schnittstelle
 */
...
/**
 *	\ingroup lcd
 *	formatierte Ausgabe auf der LCD Schnittstelle
 */
...
/**
 *	\ingroup lcd
 *	Stringausgabe auf der LCD Schnittstelle
 */
